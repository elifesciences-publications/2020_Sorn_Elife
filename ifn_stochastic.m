function [irf, usp] = ifn_stochastic(pretreatTime, numb_of_cells)
    ...
    %% initialize
    irf = zeros(1,numb_of_cells);
    usp = zeros(1,numb_of_cells);
    ...
    for i = 1:numb_of_cells
        ...
        [irf(i),usp(i)] = ifn_s(k,n1,n2,pretreatTime); % ifn_s is the function for simulating one trajectory, function provide below
    end
end
